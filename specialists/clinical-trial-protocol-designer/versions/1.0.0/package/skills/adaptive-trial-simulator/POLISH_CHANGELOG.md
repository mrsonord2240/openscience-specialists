...
Skill           : adaptive-trial-simulator
...
- [QS-2] Progressive Disclosure        : Body has 306 lines (>300), progressive disclosure recommended
...
- eval_report_adaptive-trial-simulator_result.json — OVERWRITTEN (backup: ...pre-polish.bak)
